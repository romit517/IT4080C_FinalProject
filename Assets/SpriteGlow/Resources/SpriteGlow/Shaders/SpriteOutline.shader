...
Shader "Sprites/Outline"
{
    Properties
    {
        ...
        _OutlineSize("Outline Size", Range(0, 10)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            int ShouldDrawOutlineInside (fixed4 sampledColor, float2 texCoord, int isOutlineEnabled, float outlineSize, float alphaThreshold)
            {
            ...
            // Will return 1 when the test is positive (should draw outline), 0 otherwise.
            int ShouldDrawOutlineOutside (fixed4 sampledColor, float2 texCoord, int isOutlineEnabled, float outlineSize, float alphaThreshold)
            {
